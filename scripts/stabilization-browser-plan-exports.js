async page => {
 const folder='E:/Nextstep Hacks hackathon/artifacts/verification/stabilization-v1/plan-export-set';
 ...
 await page.screenshot({path:'E:/Nextstep Hacks hackathon/output/playwright/stabilization-planner.png',fullPage:true});
 await page.reload();
