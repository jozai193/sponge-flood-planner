async page => {
 return await page.evaluate(async()=>{
  ...
  return {controlledGpuCases:results,planner:{frames:before.length,endS:final.time_s,rainM3:final.ledger.rain_m3,allSourcesInExport:true,identicalZeroDesign:before.every((f,i)=>f.depth.every((v,j)=>v===after[i].depth[j]))}};
 });
}
